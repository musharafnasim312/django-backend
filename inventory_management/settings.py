...
SECRET_KEY = 'django-insecure-p*$!%4k3fgx@hk_6&88(@-rxz56cm9(iwcbr8g1#)d&%t=2h$+'
...
# This should point to directories where your static files are located during development.
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Use 'static' for development, not 'staticfiles'
]
